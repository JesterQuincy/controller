...
class getRouting_LoaderService extends App_KernelLocalDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $d = new \Symfony\Bundle\FrameworkBundle\Routing\AnnotatedRouteControllerLoader(($container->privates['annotations.cached_reader'] ?? $container->getAnnotations_CachedReaderService()), 'local');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($c, 'local'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($c, 'local'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($c, 'local'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($c, 'local'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($c, 'local'));
